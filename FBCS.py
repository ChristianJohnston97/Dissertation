...
#G = randomNetworks.connected_watts_strogatz_graph(200, 3, 0.2)
G = randomNetworks.erdos_renyi(700, 0.1)
#print nx.info(G)
...
'''
list2 = centrality.getComparisonList(G)
_list = fbcm(G);
print "Correlation value: "
print centrality.correlation.kendallsTau(_list, list2)
'''
...
robustness.addNodes(G,m)
listB = fbcm(G)
listB = list(set(listA).intersection(listB))
tau = correlation.kendallsTau(listA, listB)
print "Robutness value: "
print tau
'''

#centrality.robustnessAddNodes(G)
#centrality.robustnessRemoveNodes(G)
